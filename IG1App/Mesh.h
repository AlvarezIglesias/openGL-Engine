...
public:
	...
	static IndexMesh* generateIndexedOpenBox(GLdouble length);
	static IndexMesh* generateIndexedPiramid(GLdouble length);
...
public:
	...
	static MbR* generaIndexTextCords(GLuint mm, GLuint mn, glm::dvec3* perfil);
